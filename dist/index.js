...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _camelCase = _interopRequireDefault(__webpack_require__(/*! lodash/camelCase */ \"lodash/camelCase\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar _default = context => {\n  const {\n    settings,\n    packagesJson\n  } = context;\n  let common = settings.webpack.common;\n\n  if (typeof common === 'function') {\n    common = common(context);\n  }\n\n  return { ...common,\n    output: { ...common.output,\n      library: {\n        root: (0, _camelCase.default)(packagesJson.process.name),\n        amd: (0, _camelCase.default)(packagesJson.process.name),\n        commonjs: packagesJson.process.name\n      },\n      libraryTarget: 'umd',\n      globalObject: 'this'\n    }\n  };\n};\n\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/settings/webpack/umd.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _path = _interopRequireDefault(__webpack_require__(/*! path */ \"path\"));\n\nvar _offlinePlugin = _interopRequireDefault(__webpack_require__(/*! offline-plugin */ \"offline-plugin\"));\n\nvar _htmlWebpackPlugin = _interopRequireDefault(__webpack_require__(/*! html-webpack-plugin */ \"html-webpack-plugin\"));\n\nvar _camelCase = _interopRequireDefault(__webpack_require__(/*! lodash/camelCase */ \"lodash/camelCase\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar _default = context => {\n  const {\n    settings,\n    paths,\n    env,\n    packagesJson,\n    banner\n  } = context;\n  const publicPath = env.PUBLIC_PATH || '/';\n  let common = settings.webpack.common;\n\n  if (typeof common === 'function') {\n    common = common(context);\n  }\n\n  const bootModulesPath = paths.boot.modules;\n  const processSrcPath = paths.process.src;\n  return { ...common,\n    target: 'web',\n    resolve: { ...common.resolve,\n      alias: { ...common.resolve.alias,\n        '@offline-plugin': _path.default.join(bootModulesPath, 'offline-plugin')\n      }\n    },\n    plugins: [...common.plugins, new _htmlWebpackPlugin.default({\n      metadata: {\n        publicPath,\n        version: env.VERSION || packagesJson.process.version,\n        author: packagesJson.process.author,\n        banner: banner || '',\n        buildDate: new Date().toString()\n      },\n      filename: 'index.html',\n      template: _path.default.resolve(processSrcPath, 'index.html'),\n      chunksSortMode: 'dependency',\n      favicon: _path.default.resolve(processSrcPath, 'assets/images/icons/favicon.ico')\n    }), new _offlinePlugin.default({\n      safeToUseOptionalCaches: true,\n      autoUpdate: false,\n      // true means 1 hour\n      caches: {\n        main: [':rest:'],\n        additional: [':externals:'],\n        optional: ['**/font/**/*.*']\n      },\n      excludes: ['**/.*', '**/*.map'],\n      externals: [],\n      rewrites: asset => asset.indexOf('web-app-manifest.json') >= 0 ? '/web-app-manifest.json' : asset.indexOf('index.html') >= 0 ? publicPath : asset,\n      ServiceWorker: {\n        // cacheName is very dangerous: CAN NOT CHANGE\n        cacheName: `${(0, _camelCase.default)(packagesJson.process.name)}:${(0, _camelCase.default)(publicPath) || 'index'}`,\n        events: true,\n        output: 'sw.js',\n        navigateFallbackURL: publicPath\n      },\n      AppCache: {\n        events: true,\n        caches: ['main', 'additional', 'optional'],\n        FALLBACK: {\n          [publicPath]: publicPath\n        }\n      }\n    })]\n  };\n};\n\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/settings/webpack/web/common.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _fs = _interopRequireDefault(__webpack_require__(/*! fs */ \"fs\"));\n\nvar _logger = _interopRequireDefault(__webpack_require__(/*! ../logger */ \"./src/logger.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar _default = (file, encoding = 'utf8') => new Promise((resolve, reject) => {\n  _logger.default.info(`Reading file \"${file}\"...`);\n\n  _fs.default.readFile(file, encoding, (err, data) => {\n    if (err) {\n      reject(err);\n      return;\n    }\n\n    resolve(data);\n  });\n});\n\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/utils/read-file.js?");
